            ...
            <div className="bg-white container mx-auto  rounded-2xl relative top-20 xl:p-[88px] lg:p-14 md:p-10 p-2 flex lg:flex-row flex-col items-center justify-between shadow-[0px_59px_124px_0px_#0000001f]">
                ...
                <div className="lg:max-w-[40%]">
                    <h3 className="lg:text-4xl font-semibold md:text-3xl text-2xl mb-4 text-text-primary">
                        s experiências com ferramentas como Power BI, SAP, SQL, além de dicas de boas práticas de desenvolvimento e automação. A ideia é dividir meus conhecimentos para ajudar outros profissionais da área e aqueles que estão começando. Fique à vontade para explorar e aprender mais sobre essas tecnologias que estão moldando o futuro.
                    </h3>
