...
const contacts = [
    {
        icon: <HiOutlineLocationMarker className="rounded transition size-12 p-3 text-primary bg-biege/40 group-hover:text-white group-hover:bg-primary" />,
        title: "Endereço",
    ...
    {
        icon: <HiOutlineMail className="rounded transition size-12 p-3 text-primary bg-biege/40 group-hover:text-white group-hover:bg-primary" />,
        title: "Meu Email:",
        link: "davidalss041@gmail.com",
        href: "mailto:davidalss041@gmail.com",
    },
    {
        icon: <IoCallOutline className="rounded transition size-12 p-3 text-primary bg-biege/40 group-hover:text-white group-hover:bg-primary" />,
        title: "Meu Contato:",
...
const Contact = () => {
    const createContactEntry = async (data, e) => {
        try {
            ...
            console.log("Erro ao criar entrada de contato:", error)
        }
    }
    ...
    return (
        ...
        >
            <div className="bg-white container mx-auto rounded-2xl relative top-20 xl:p-[88px] lg:p-14 md:p-10 p-2 flex lg:flex-row flex-col items-center justify-between shadow-[0px_59px_124px_0px_#0000001f]">
                ...
                <div className="lg:max-w-[40%] text-center lg:text-left">
                ...
                <div className="lg:max-w-[50%]">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-4 text-lg text-text-secondary">
                        <input
                            type="text"
                            name="name"
                            placeholder="Nome"
